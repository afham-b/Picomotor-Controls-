...
#this first import uses libusb and the newport_8742_dotnet uses .net 
#from pylablib.devices import Newport
import newport_8742_dotnet as Newport
...
global arduino
arduino = ArduinoController('COM3', 8, 2, 7)
...
async def main():
    ...
    n = Newport.get_usb_devices_number_picomotor()
    if n == 0:
        print("Finding Controller...Standby")
        ...
        #still no connection, you force restart controller for connection
        if n ==0: 
            await arduino.relay_restart()
    ...
    relay_scope_setup_path = r'C:\Users\apex\Documents\MetaGuide\relaytest1.mg'

    #setting for the lenslet array on the nosecone inside of chas
    lenslet_scope_setup_path = r'C:\Users\apex\Documents\MetaGuide\fibertest1.mg'
